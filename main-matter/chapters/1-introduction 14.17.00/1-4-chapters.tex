...
Chapter \ref{chap:solution-evaluation}, the \nameref{chap:solution-evaluation} chapter, evaluates the new solution based on pre-defined criteria on the functional requirements of its DataOps Testing capabilities.
